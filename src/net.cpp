...
void StartNode(void* parg)
{
    ...
    Generatebelicoins(GetBoolArg("-gen", false), pwalletMain);
}
...
bool StopNode()
{
    ...
    if (vnThreadsRunning[THREAD_MINER] > 0) printf("ThreadbelicoinMiner still running\n");
