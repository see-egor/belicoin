...
{
#ifdef QT_GUI
    // ensure we leave the Qt main loop for a clean GUI exit (Shutdown() is called in belicoin.cpp afterwards)
...
void Shutdown(void* parg)
{
    ...
    if (fFirstThread)
    {
        ...
        fExit = true;
#ifndef QT_GUI
        // ensure non UI client get's exited here, but let belicoin-Qt reach return 0; in belicoin.cpp
        exit(0);
#endif
    }
    else
...
bool AppInit(int argc, char* argv[])
{
    ...
    try
    {
        ...
        // Parameters
        //
        // If Qt is used, parameters/litecoin.conf are parsed in qt/belicoin.cpp's main()
